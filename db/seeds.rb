...
User.create(
    [
        ...
        },
        {
            ...
            patronymic: 'Доброго Стоматолога',
    ...
    [
        {
            ...
            avatar: open('public/images/medic/avatar/1/bg-doctor_m2.png'),
        ...
        },
        {
            ...
            post3: 'Пародонтолог',
            avatar: open('public/images/medic/avatar/2/doc_zhigunova.jpg'),
        ...
        },
        {
            ...
            post3: '',
            avatar: open('public/images/medic/avatar/3/doc_dubin.jpg'),
        ...
        },
        {
            ...
            avatar: open('public/images/medic/avatar/4/bd1.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/5/doc_ivanina.jpg'),
        ...
        },
        {
            ...
            post2: 'Детский стоматолог',
            post3: '',
            avatar: open('public/images/medic/avatar/6/doc_tihan.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/7/doc_carkova.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/8/Philina@2.jpg'),
        ...
        },
        {
            ...
            post3: '',
            avatar: open('public/images/medic/avatar/9/doc_ocun.jpg'),
        ...
        },
        {
            ...
            post3: '',
            avatar: open('public/images/medic/avatar/10/Konishev@2.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/11/doc_shenikova.jpg'),
        ...
        },
        {
            ...
            post2: 'Имплантолог',
            post3: '',
            avatar: open('public/images/medic/avatar/12/orlov.jpg'),
        ...
        },
        {
            ...
            post2: 'Детский стоматолог',
            post3: '',
            avatar: open('public/images/medic/avatar/13/doc_batukova.jpg'),
        ...
        },
        {
            ...
            post2: 'Детский стоматолог',
            post3: '',
            avatar: open('public/images/medic/avatar/14/doc_belolubskaya.jpg'),
        ...
        },
        {
            ...
            post2: 'Пародонтолог',
            post3: '',
            avatar: open('public/images/medic/avatar/15/doc_zhivotovskaya.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/16/doc_zaharchenko.jpg'),
        ...
        },
        {
            ...
            post2: 'Детский стоматолог',
            post3: '',
            avatar: open('public/images/medic/avatar/17/doc_komarova.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/18/samsonov.jpg'),
        ...
        },
        {
            ...
            post2: 'Пародонтолог',
            post3: '',
            avatar: open('public/images/medic/avatar/19/kalishyk.jpg'),
        ...
        },
        {
            ...
            post2: 'Имплантолог',
            post3: '',
            avatar: open('public/images/medic/avatar/20/doc_kobaliya_new.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/21/golubeva.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/22/doc_savinkina.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/23/maksimov.jpg'),
        ...
        },
        {
            ...
            post3: '',
            avatar: open('public/images/medic/avatar/24/onoshko.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/25/Shashorina@2.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/26/Shamatava@2.jpg'),
        ...
        },
        {
            ...
            post2: 'Пародонтолог',
            post3: '',
            avatar: open('public/images/medic/avatar/27/Sladkov@2.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/28/petrashen.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/29/sapickaya.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/30/Sokolova@2.jpg'),
        ...
        },
        {
            ...
            post2: '',
            post3: '',
            avatar: open('public/images/medic/avatar/31/Listopad@2.jpg'),
        ...
        },
        {
            ...
            post3: '',
            avatar: '',
            about: 'Администратор во всех филиалах Клиники Доброго Стоматолога. Обращайтесь ко мне по всем возникающим вопросам.',
            raiting: 0,
            status_medic: 0
        },
    ]
...
Article.create(
    [
        {
            title: 'Насколько чувствительны Ваши зубы?',
            description: 'Способные ли кислые продукты питания или неправильно подобранная зубная паста испортить Ваше настроение?',
            text: '<h1>Насколько чувствительны Ваши зубы?</h1>
<p>Способные ли кислые продукты питания или неправильно подобранная зубная паста испортить Ваше настроение?</p>
<p>Бывает ли такое, что когда Вы едите замороженный йогурт, Вы кривитесь от боли в зубах? Или морщитесь при чистке зубов щеткой/зубочисткой? Если да, то возможно у Вас повышенная чувствительность зубов.</p>
<p>Но у Вас нет нужды мириться с этой болью! На самом деле, существуют способы, при которых можно уменьшить чувствительность зубов и даже улучшить состояние полости рта.</p>
<p>Ниже приведены причины, отчего может возникнуть данное заболевание полости рта, а также необходимые меры, чтобы <strong>облегчить боль</strong>:</p>
<ul>
<li><strong>Вы чистите зубы чересчур тщательно</strong>. Иногда чувствительность зубов появляется от того, что Вы используете щетку с очень жесткой щетиной. С течением времени защитная оболочка наших зубов изнашивается, и тот слой, где находятся микроскопические трубочки и канальца, ведущие прямо к нервным окончаниям, становится уязвимым. Поэтому когда мы едим что-то горячее, холодное или кислое, мы чувствуем боль в зубах. Самое простое решение этой проблеме – поменять Вашу зубную щетку на щетку с меньшей степенью жесткости и чистить не так сильно.</li>
<li><strong>Вы едите много кислой пищи</strong>. Если пути к нервным окончаниям оголены, то такая кислая пища, как кетчуп, лимон, грейпфрут, киви и маринованные продукты могут причинять боль. Подумайте внимательно – все, что Вам нужно, - это исключить данные продукты из своего рациона.</li>
<li><strong>Вы пользуетесь шлифовкой зубов</strong>. Шлифовка зубов может серьезно повредить эмаль, несмотря на тот факт, что она - самая твердая ткань в нашем теле. Данная процедура подвергает дентин, средний слой зуба, большой опасности, так как он содержит полые трубочки, которые ведут к нервным окончаниям. «Вам следует поговорить с Вашим стоматологом о поиске средства, способного защитить полость рта, чтобы отказаться от шлифовки зубов. Будет лучше, если он подберет Вам что-то индивидуальное», - говорит доктор Сэлдин.</li>
<li><strong>Вы используете отбеливающую пасту</strong>. Многие производители добавляют отбеливающие химические вещества в основной состав их паст, и некоторые потребители более чувствительны к таким пастам, нежели другие. Если Ваша зубная паста может быть источником повышенной чувствительности зубов, всерьез задумайтесь о ее смене.</li>
<li><strong>Вы слишком часто поласкаете рот</strong>. Как и отбеливающие зубные пасты, некоторые жидкости для полоскания рта содержат алкоголь и другие химические материалы, которые делают Ваши зубы более чувствительными, и воздействуют на дентин. Решение есть! Попробуйте полоскать рот раствором нейтрального фторида или просто замените процедуры полоскания на зубную нить и щетку.</li>
<li><strong>У Вас имеется заболевание десен</strong>. Удаление десен, что в последнее время становится обычным делом, особенно если Вы не следите за здоровьем полости рта, может также быть причиной повышенной чувствительности зубов. Если заболевание десен или их воспаление – Ваша проблема, Ваш стоматолог может предложить процедуру, направленную на пломбирование зубов в процессе лечения заболевания десен.</li>
<li><strong>У вас наблюдается избыточный зубной налет</strong>. Настоящая цель зубной нити и щетки – удалить остатки пищи после приема пищи. Чрезмерное накопление зубного налета может быть причиной стирания эмали. И опять, Ваши зубы становятся более чувствительными, теряя защитную эмаль. Решение известно каждому из нас – каждый день следить за полостью рта и не забывать посещать стоматолога каждые 6 месяцев (или чаще, если необходимо) для профилактики.</li>
<li><strong>Недавние посещения стоматолога</strong>. Зубы часто становятся более чувствительными после того, как Вы побывали на приеме. Часто это происходит после лечения корневого канала, извлечения или установки коронки. Если чувствительность зубов не исчезает долгое время, зайдите к стоматологу еще раз – есть вероятность попадания инфекции.</li>
<li><strong>Ваш зуб треснул</strong>. Отколотый или треснувший зуб может быть причиной возникновения чувствительности зубов. Вашему стоматологу нужно будет оценить состояние Ваших зубов и составить правильный курс лечения, например, удалить зуб.</li>
<li><strong>У Вас присутствует кариес на местах пломбы</strong>. С возрастом нам не следует забывать и о том, что пломбы с имеют способность выпадать или неплотно прилегать к зубу. Такие зубы – прекрасные места скопления различных бактерий, которые и являются причиной увеличения кислотности организма и разрушения эмали. Обратитесь к своему стоматологу, если заметили что-то похожее после установки пломбы, и врач заменит ее.</li>
</ul>
<p>Хочется заверить, чувствительность зубов лечится. Вы без труда можете использовать специальную пасту для чувствительных зубов, чтобы решить эту проблему. Однако стоит помнить о том, что не с каждым это сработает.</p>
<p>Если Ваша чувствительность все еще присутствует вне зависимости от того, какой из способов Вы перепробовали, обратитесь к стоматологу для проведения осмотра. Среди возможных способов лечения, врач может назначить гель на основе фторида, чтобы наносить его на места повышенной чувствительности. Это применяется для снижения чувствительности и укрепления зубной эмали. И, конечно, только находясь во врачебном кабинете, Вы сможете определить наиболее вероятную причину появления чувствительности зубов у Вас и выбрать подходящее решение.</p>
'
        },
        {
            title: 'Как побороть в себе страх перед посещением стоматолога?',
            description: 'Страх перед походом к стоматологу (стоматологическая фобия) является актуальным клиническим термином.',
            text: '<h1>Как побороть в себе страх перед посещением стоматолога?</h1>
<p>Страх перед походом к стоматологу (<strong>стоматологическая фобия</strong>) является актуальным клиническим термином. Если вы один из миллионов людей, которые страдают от этого, то вам будет интересно узнать, откуда и как приходит этот страх и как его побороть.</p>
<p>В наше время уровень стоматологической помощи вырос настолько, что практически нет тех болезней, которые не могли бы вылечить врачи – стоматологи. Но при этом заболеваниями десен или зубов страдает огромное количество людей по всему миру. Так в чем же может быть дело?</p>
<p>Одним из таких факторов является стоматологическая фобия, которая может быть настолько серьезной, что может привести к откладыванию визита к врачу до самого последнего момента. Промедление посещения врача часто приводит к тому, чтотолько начавшееся заболевание, например, крошечная полость в зубе, развивается и может привести к серьезному и дорогостоящему хирургическому вмешательству.</p>
<p>Люди зачастую верят в мифы, которые так или иначе связаны с стоматологией. А для некоторых потенциальных пациентов достаточно услышать какую либо фразу, термин, например, очистка корневого канала, и этого достаточно, чтобы в голове возникли образы боли и страданий.</p>
<p>Для врачей – стоматологов этот вид страха настолько обычное дело, что большинство из них считаю его одним из важных составляющих своей повседневной практики.</p>
<p>Врачи обнаружили, что пациенты особенно боятся одной конкретной вещи: иглы. Связано ли это с детскими воспоминаниями или есть неприятный опыт взрослой жизни, но страх получить укол, особенно во рту, это почти всегдавызывает эмоции у пациентов.</p>
<p> В этом случае  для пациентов важно знать: врач знает про ваш страх и сможет вам помочь, применив местную анестезию без использования инъекции до того, как использовать иглы. Но в большинстве случаев на приеме врач может успокоить, просто поговорив пару минут на отвлеченные темы.</p>
<p>Некоторые пациенты испытывают беспокойство по поводу онемения после анестезии. Людям кажется что «заморозилась» намного большая площадь, чем надо. К этому страху добавляется тревожное ожидание боли. Учитывая пронзительное сверление, брызги воды и запах горелого зуба мозг тревожного пациента может вызвать разные ассоциации. И здесь важно понять, что идет лечение, и нет никакой причины переживать: надо просто не думать о том, что происходит с вами в данный момент, переключитесь на мысли о том, как будет хорошо выглядеть ваша улыбка.</p>
<p>Если вы когда-либо испытывали неожиданную боль во время стоматологической процедуры, то она останется в вашей памяти. Даже если это случилось только один раз, и это было много лет в прошлом… Тревожный пациент будет ожидать этого. Но наука анестезиологии развивается, и сейчас многие препараты препятствуют возникновению внезапной боли. Возможная боль – она только в вашем сознании.</p>
<p>Стоматология прошла долгий путь за последние несколько десятилетий. Большие успехи были достигнуты в оказании медицинской помощи, особенно в управлении тревогами и страхами. Безболезненный уколэто реальность сегодня. Это существенная реальность.</p>
<p><strong>Если вы боитесь стоматолога, вот наши советы</strong>:</p>
<ul>
<li>Не избегайте визита к стоматологу только потому, что мысль о предстоящем лечении вас парализует.</li>
<li>Позвоните в стоматологию и попросите о консультации.Только о консультации.</li>
<li>Идите на встречу со стоматолога с осознанием того, что никаких манипуляций не будет сделано в этот день.</li>
<li>Если у вас появилось доверие к стоматологу, то не бойтесь сказать, что вы испытываете страх. Не бойтесь задавать вопросы.</li>
<li>Если вы видите, что вас понимают, ваши проблемы решаемы, решайтесь на лечение. Если же вас что то не устраивает, попробуйте иную клинику.</li>
</ul>
<p>Консультация является первым шагом в преодолении ваших страхов. Преодолевая свой страх, вы избежите многих проблем в будущем.</p>
'
        }
    ]
)
...
Review.create(
    [
        {
            user_id: 33,
            text_reviews: 'Это был мой первый визит к стоматологу-хирургу. Операция предстояла сложная, удаление ретинированного зуба мудрости. Все прошло без нареканий и болезненных ощущений. Выражаю свою благодарность Орлову Петру Николаевичу!',
            status_review: 1
        },
        {
            user_id: 34,
            text_reviews: 'Татьяна Владимировна -прекрасный врач, отличный специалист, наблюдаюсь и лечусь у неё около 8 лет и планирую продолжать. Лечение проходит быстро и безболезненно, всегда разработан дальнейший оптимальный план лечения, своевременно предпринимает превентивные меры, все процедуры и их необходимость объясняет. Хочется отметить, что Татьяна Владимировна прекрасно работает со своим ассистентом Светланой, чувствуется отличная и слаженная работа команды. Я очень довольна и благодарна им обеим за качественное лечение и внимательное отношение.',
            status_review: 1
        },
    ...
    [
        {
            patient_id: 1,
            medic_id: 3,
            text_question: 'Здравствуйте, сколько у вас будет стоить удаление трёх ретинированных восьмёрок под общим наркозом? Примерный диапазон цен.',
            text_answer: 'Здравствуйте! В нашей клинике возможно удаление под медикаментозным сном. 1 час общей анестезии 11238 р. Удаление ретинированного зуба от 5000 и выше. Более точную сумму Вам сможет сказать хирург после осмотра и снимка.',
            status_question: 1
        },
        {
            patient_id: 2,
            medic_id: 14,
            text_question: 'К кому и в каком порядке идти на прием, если моя проблема комплексная: - нужно удалить зуб и поставить на его место имплант - при всем этом у меня неправильный прикус - практически все зубы имеют пломбы различной давности, под многими из которых есть потемнения Также хотелось бы, чтобы врач(и) на приеме не позволяли оценивать внешность пациента, т.к. не все рождаются красивыми, и не все имели возможность вовремя исправить дефекты (привет советской стоматологии и врачам одной блестящей и красивой клиники), но мы все же идем идем к врачам за помощью, а не за оценками, и с теми средствами, которые у нас есть. Спасибо заранее за ответ.',
            text_answer: 'Добрый день! Вам необходимо записаться на совместную консультацию всех специалистов (терапевт, ортодонт, хирург-имплантолог, ортопед) для составления комплексного плана лечения.',
            status_question: 1
        },
    ]
)