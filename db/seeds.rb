...
Price.create(
    [
        {name: 'Осмотр-консультация', price: 625, departament_id: 5},
        {name: 'Диагностическое обследование с составлением плана лечения', price: 5200, departament_id: 5},
        {name: 'Снятие слепков и отливка гипсовых (альгинат) моделей', price: 1000, departament_id: 5},
        {name: 'Снятие слепков под брекет-систему Incoqnito', price: 3500, departament_id: 5},
        {name: 'Контрольный осмотр (без активации аппаратов)', price: 250, departament_id: 5},
        {name: 'Избирательное пришлифовывание молочного зуба', price: 200, departament_id: 5},
        {name: 'Полный курс лечения на (лигатурной) металлической брекет – системе -1 челюсть', price: 67000, departament_id: 5},
        {name: 'Полный курс лечения на металлической саморегулирующей брекет – системе Damon Q - 1 челюсть', price: 75000, departament_id: 5},
        {name: 'Полный курс лечения на (лигатурной) керамической, сапфировой брекет – системе Inspire, Clarity) - 1 челюсть', price: 85000, departament_id: 5},
        {name: 'Полный курс лечения на керамической саморегулирующей брекет – системе Damon Clear- 1 челюсть', price: 95000, departament_id: 5},
        {name: 'Полный курс лечения на брекет – системе Incoqnito- 1 челюсть', price: 250000, departament_id: 5},
        {name: 'Полный курс лечения на прозрачных каппах (Star Smile) - 1 челюсть', price: 150000, departament_id: 5},
        {name: 'Полный курс лечения на лингвальной брекет – системе WIN – 1 челюсть', price: 200000, departament_id: 5},
        {name: 'Фиксация лингвальной брекет – системы WIN - 1 челюсть', price: 100000, departament_id: 5},
        {name: 'Фиксация металлической брекет – системы (лигатурная) (ORMCO, 3M ) - 1 челюсть', price: 25900, departament_id: 5},
        {name: 'Фиксация металлической саморегулирующей брекет – системе Damon Q - 1 челюсть', price: 33000, departament_id: 5},
        {name: 'Фиксация керамической, сапфировой брекет-системы (ORMCO, 3М) -1 челюсть', price: 38900, departament_id: 5},
        {name: 'Фиксация керамической саморегулирующей брекет – системы Damon Clear - 1 челюсть', price: 45000, departament_id: 5},
        {name: 'Фиксация лингвальной брекет – системы Incoqnito - 1 челюсть', price: 180000, departament_id: 5},
        {name: 'Изготовление и припасовка прозрачных капп', price: 110000, departament_id: 5},
        {name: 'Активация капп', price: 3800, departament_id: 5},
        {name: 'Активация вестибулярной брекет-системы – 1 челюсть', price: 1800, departament_id: 5},
        {name: 'Активация лингвальной брекет-системы - 1 челюсть', price: 3000, departament_id: 5},
        {name: 'Активация лингвальной брекет-системы - 2 челюсти', price: 5000, departament_id: 5},
        {name: 'Замена брекета металлического', price: 1200, departament_id: 5},
        {name: 'Замена брекета Damon Q', price: 1500, departament_id: 5},
        {name: 'Замена эстетического брекета', price: 1700, departament_id: 5},
        {name: 'Замена брекета Damon Clear', price: 2200, departament_id: 5},
        {name: 'Фиксация ортодонтического элемента, установленного вне клиники', price: 2600, departament_id: 5},
        {name: 'Изготовление и припасовка аппарата Дерихсвайлера, Хааса', price: 19800, departament_id: 5},
        {name: 'Лицевая маска', price: 18000, departament_id: 5},
        {name: 'Изготовление и постановка небного бюгеля/лингвальной дуги', price: 7800, departament_id: 5},
        {name: 'Постановка пружины для выравнивания моляров', price: 3800, departament_id: 5},
        {name: 'Аппарат Forsus', price: 17000, departament_id: 5},
        {name: 'Аппарат Nance', price: 5600, departament_id: 5},
        {name: 'Кнопка Mini-Mold 1шт.', price: 700, departament_id: 5},
        {name: 'Накусочный брекет', price: 2200, departament_id: 5},
        {name: 'Кнопка лингвальная', price: 1000, departament_id: 5},
        {name: 'Применение одного миниимпланта в ортодонтическом лечении', price: 5000, departament_id: 5},
        {name: 'Активация тяг к миниимплантам', price: 1000, departament_id: 5},
        {name: 'Снятие брекета вестибулярного (1 зуб)', price: 400, departament_id: 5},
        {name: 'Снятие брекета лингвального (1 зуб)', price: 630, departament_id: 5},
        {name: 'Фиксация ретейнера к 1 зубу', price: 1100, departament_id: 5},
        {name: 'Снятие ретейнера с 1 зуба', price: 900, departament_id: 5},
        {name: 'Съёмный OSAMU- ретейнер', price: 9700, departament_id: 5},
        {name: 'Съёмный HOWLEY - ретейнер', price: 12500, departament_id: 5},
        {name: 'Изготовление и припасовка одночелюстного аппарата', price: 16700, departament_id: 5},
        {name: 'Изготовление и припасовка двучелюстного аппарата', price: 22500, departament_id: 5},
        {name: 'Активация одночелюстного аппарата', price: 800, departament_id: 5},
        {name: 'Активация двучелюстного аппарата', price: 800, departament_id: 5},
        {name: 'Профилактический протез (съемный)', price: 12800, departament_id: 5},
        {name: 'Осмотр-консультация', price: 625, departament_id: 11},
        {name: 'Профилактическая гигиена в области импланта', price: 630, departament_id: 11},
        {name: 'Профессиональное отбеливание (Luma-Arch)', price: 14700, departament_id: 11},
        {name: 'Снятие зубных отложений', price: 84, departament_id: 11},
        {name: 'Снятие налета аппаратом "Prophyflex"', price: 84, departament_id: 11},
        {name: 'Покрытие фторлаком однократное', price: 42, departament_id: 11},
        {name: 'Подбор средств гигиены и обучение без выдачи экземпляра', price: 420, departament_id: 11},
        {name: 'Обучение гигиене полости рта с выдачей экземпляров щетки', price: 534, departament_id: 11},
        {name: 'Индивидуальный подбор размеров ершиков с выдачей экземпляров', price: 766, departament_id: 11},
        {name: 'Использование профессиональной фтористой системы', price: 2940, departament_id: 11},
        {name: 'Отбеливающая система «Opalescence TresWhite', price: 7378, departament_id: 11},
        {name: 'Ирригатор WaterPik – 100E Ultra', price: 11150, departament_id: 11},
        {name: 'Портативный Ирригатор WaterPik – 360E (дорожный)', price: 7500, departament_id: 11},
        {name: 'Обучение гигиене полости рта с выдачей жидкости для полоскания', price: 851, departament_id: 11},
        {name: 'Профессиональная чистка полости рта с использованием порошка Clinpro Prophy Powder', price: 5108, departament_id: 11},
        {name: 'Применение абразивной (полировочной) пасты Clinpro Prophy Paste', price: 114, departament_id: 11},
        {name: 'Применение фторсодержащего покрытия с трикальцийфосфатом Clinpro Prophy Varnish', price: 568, departament_id: 11},
        {name: 'Применение материала с выделением фтора для длительной защиты зубов Clinpro XT Varnish (за 1 зуб)', price: 170, departament_id: 11},
        {name: 'Применение фиссурного герметика Clinpro Sealant при герметизации фиссур у детей', price: 1476, departament_id: 11},
        {name: 'Обучение гигиене полости рта с выдачей экземпляра зубной пасты Clinpro Tooth Creme', price: 454, departament_id: 11},
        {name: 'Осмотр-консультация', price: 625, departament_id: 6},
        {name: 'Лечение кариеса временного зуба', price: 3349, departament_id: 6},
        {name: 'Лечение пульпита временного зуба в одно посещение', price: 5108, departament_id: 6},
        {name: 'Лечение пульпита временного зуба - первое посещение', price: 1703, departament_id: 6},
        {name: 'Лечение пульпита временного зуба – второе посещение', price: 3405, departament_id: 6},
        {name: 'Отсроченное лечение кариеса постоянного зуба (1 этап)', price: 2838, departament_id: 6},
        {name: 'Удаление временного зуба (простое)', price: 1260, departament_id: 6},
        {name: 'Удаление временного зуба (сложное)', price: 2838, departament_id: 6},
        {name: 'Герметизация фиссур одного зуба (неинвазивная методика)', price: 1135, departament_id: 6},
        {name: 'Герметизация фиссур одного зуба (инвазивная методика)', price: 1476, departament_id: 6},
        {name: 'Серебрение одного зуба', price: 284, departament_id: 6},
        {name: 'Комплекс лечебно – профилактических мероприятий детям до 14 лет', price: 2270, departament_id: 6},
        {name: 'Урок гигиены', price: 511, departament_id: 6},
        {name: 'Профилактическая программа Dental Resources', price: 1703, departament_id: 6},
        {name: 'Реминерализующая терапия (за 1 зуб)', price: 56, departament_id: 6},
        {name: 'Оформление справки (для постоянных пациентов клиники)', price: 284, departament_id: 6},
        {name: 'Лечение под общей анестезией кариеса временного зуба', price: 2838, departament_id: 6},
        {name: 'Лечение под общей анестезией пульпита временного зуба', price: 3973, departament_id: 6},
        {name: 'Удаление под общей анестезией временного зуба', price: 1249, departament_id: 6},
        {name: 'Осмотр-консультация', price: 625, departament_id: 3},
        {name: 'Имплантат Astra Tech', price: 41920, departament_id: 3},
        {name: 'Имплантат Direct', price: 34540, departament_id: 3},
        {name: 'Имплантат Replace', price: 38821, departament_id: 3},
        {name: 'Имплантат Ankylos', price: 40552, departament_id: 3},
        {name: 'Имплантат OSSTEM', price: 14500, departament_id: 3},
        {name: 'Установка ФДМ', price: 2951, departament_id: 3},
        {name: 'Синуслифтинг закрытый', price: 20580, departament_id: 3},
        {name: 'Синуслифтинг открытый', price: 27300, departament_id: 3},
        {name: 'Материал Bio – oss, 1 флакон', price: 10500, departament_id: 3},
        {name: 'Пересадка кости', price: 22249, departament_id: 3},
        {name: 'Подсадка костной ткани методом направленной тканевой регенерации', price: 28151, departament_id: 3},
        {name: 'Удаление простое', price: 1181, departament_id: 3},
        {name: 'Удаление сложное', price: 1680, departament_id: 3},
        {name: 'Удаление зуба атравматичное', price: 1975, departament_id: 3},
        {name: 'Удаление ретинированного зуба', price: 2940, departament_id: 3},
        {name: 'Резекция однокорневого зуба', price: 3360, departament_id: 3},
        {name: 'Резекция трехкорневого зуба', price: 5040, departament_id: 3},
        {name: 'Кюретаж лунки', price: 420, departament_id: 3},
        {name: 'Внутриротовой разрез', price: 681, departament_id: 3},
        {name: 'Остеотропные (или медикаментозные средства)', price: 420, departament_id: 3},
        {name: 'Гемисекция', price: 4200, departament_id: 3},
        {name: 'Коррекция альвеолярного гребня', price: 1476, departament_id: 3},
        {name: 'Вскрытие пародонтального абсцесса', price: 681, departament_id: 3},
        {name: 'Удаление пластинчатого имплантата', price: 7560, departament_id: 3},
        {name: 'Удаление винтового имплантата', price: 5040, departament_id: 3},
        {name: 'Установка миниимпланта', price: 5676, departament_id: 3},
        {name: 'Визуализация', price: 3065, departament_id: 3},
        {name: 'Расщепление альвеолярного гребня', price: 9649, departament_id: 3},
        {name: 'Эстетическое удлинение коронковой части зуба (в области одного зуба)', price: 7038, departament_id: 3},
        {name: 'Швы викрил Нить Супрамид', price: 410, departament_id: 3},
        {name: 'Иссечение капюшона', price: 2500, departament_id: 3},
        {name: 'Хирургический шаблон Nobel Guide до 5 имплантов', price: 25700, departament_id: 3},
        {name: 'Хирургический шаблон Nobel Guide более 5 имплантов', price: 29700, departament_id: 3},
        {name: 'Хирургический шаблон Nobel Guide 2G', price: 15800, departament_id: 3},
        {name: 'Закрытие ороантрального сообщения после удаления (ОАС)', price: 5000, departament_id: 3},
        {name: 'Использование инструмента для удаления имплантата', price: 3000, departament_id: 3},
        {name: 'Швы кетгут', price: 136, departament_id: 3},
        {name: 'Осмотр-консультация', price: 625, departament_id: 1},
        {name: 'Подкладка лечебная', price: 284, departament_id: 1},
        {name: 'Подкладка изолирующая СИЦ', price: 511, departament_id: 1},
        {name: 'Подкладка из цемента тройного отверждения (Витремер)', price: 795, departament_id: 1},
        {name: 'Подкладка из жидкотекучего композита', price: 795, departament_id: 1},
        {name: 'Подкладка из компомера', price: 851, departament_id: 1},
        {name: 'Стеклоиономерным цементом восстановление одной поверхности зуба', price: 851, departament_id: 1},
        {name: 'Светоотверждаемым композитом восстановление одной поверхности зуба', price: 1476, departament_id: 1},
        {name: 'Восстановление 1 поверхности зуба цементом тройного отверждения', price: 1260, departament_id: 1},
        {name: 'Восстановление пришеечной области зуба', price: 2157, departament_id: 1},
        {name: 'Неинвазивный метод лечения кариеса', price: 2838, departament_id: 1},
        {name: 'Покрытие реставрации лаком', price: 126, departament_id: 1},
        {name: 'Наложение девитализирующей пасты', price: 454, departament_id: 1},
        {name: 'ММО канала одноканального зуба (первый визит)', price: 2838, departament_id: 1},
        {name: 'ММО одного канала многоканального зуба (первый визит)', price: 1703, departament_id: 1},
        {name: 'ММО канала (повторный визит)', price: 1135, departament_id: 1},
        {name: 'Пломбирование канала временным герметиком (1 канал)', price: 568, departament_id: 1},
        {name: 'Наложение лекарственных повязок', price: 397, departament_id: 1},
        {name: 'Распломбировка простая', price: 1362, departament_id: 1},
        {name: 'Распломбировка сложная', price: 2610, departament_id: 1},
        {name: 'Распломбировка стекловолокна', price: 2838, departament_id: 1},
        {name: 'Извлечение инородного тела из канала зуба', price: 1260, departament_id: 1},
        {name: 'Извлечение анкерного штифта из канала зуба', price: 1703, departament_id: 1},
        {name: 'Извлечение вкв из канала зуба', price: 2838, departament_id: 1},
        {name: '1 канала пломбировка гуттаперчей', price: 2838, departament_id: 1},
        {name: '1 канала пломбировка методом вертикальной конденсации', price: 3746, departament_id: 1},
        {name: '2-х каналов пломбировка гуттаперчей', price: 3746, departament_id: 1},
        {name: '2-х каналов пломбировка методом вертикальной конденсации', price: 4541, departament_id: 1},
        {name: '3-х каналов пломбировка гуттаперчей', price: 4541, departament_id: 1},
        {name: '3-х каналов пломбировка методом вертикальной конденсации', price: 5449, departament_id: 1},
        {name: '4-х каналов пломбировка гуттаперчей', price: 5449, departament_id: 1},
        {name: '4-х каналов пломбировка методом вертикальной конденсации', price: 5676, departament_id: 1},
        {name: 'Штифт гуттаперчевый (1 шт.)', price: 40, departament_id: 1},
        {name: 'Повторное посещение при лечении периодонтита', price: 454, departament_id: 1},
        {name: 'Стекловолоконный штифт армирование', price: 851, departament_id: 1},
        {name: 'Микропротезирование с использованием стекловолокна (1 ед.)', price: 8190, departament_id: 1},
        {name: 'Фиксация штифта на цемент двойного отверждения', price: 795, departament_id: 1},
        {name: 'Подкладка из материала Про Рут', price: 1476, departament_id: 1},
        {name: 'Компьютерная диагностика', price: 284, departament_id: 7},
        {name: 'Компьютерная диагностика с распечаткой', price: 341, departament_id: 7},
        {name: 'Ортопантомограмма с распечаткой', price: 851, departament_id: 7},
        {name: 'Ортопантомограмма без распечатки', price: 795, departament_id: 7},
        {name: 'Трехмерное рентгенологическое исследования области размером 23*17', price: 2700, departament_id: 7},
        {name: 'Трехмерное рентгенологическое исследования одной челюсти', price: 1800, departament_id: 7},
        {name: 'Трехмерное рентгенологическое исследования двух челюстей', price: 2400, departament_id: 7},
        {name: 'Осмотр-консультация', price: 625, departament_id: 4},
        {name: 'Пародонтический скейлинг (1 зуб)', price: 284, departament_id: 4},
        {name: 'Закрытый кюретаж за 1 ед.', price: 2497, departament_id: 4},
        {name: 'Открытый кюретаж за 1 ед.', price: 3746, departament_id: 4},
        {name: 'Френулопластика', price: 4768, departament_id: 4},
        {name: 'Вестибулопластика', price: 9592, departament_id: 4},
        {name: 'Гингивэктомия', price: 1362, departament_id: 4},
        {name: 'Лоскутная операция при пародонтите (1 сегмент до 6 зубов)', price: 10784, departament_id: 4},
        {name: 'Применение резорбируемой мембраны Bio-Gide', price: 11350, departament_id: 4},
        {name: 'Применение остеотропного препарата Bio-Oss collagen', price: 8700, departament_id: 4},
        {name: 'Применение остеотропного препарата Bio-Oss spongiosa 0,5', price: 7750, departament_id: 4},
        {name: 'Избирательная пришлифовка зубов по методу Дженкельсона (1 посещение)', price: 2270, departament_id: 4},
        {name: 'Удлинение коронковой части зуба', price: 4484, departament_id: 4},
        {name: 'Наращивание альвеолярного гребня с использованием мягких тканей', price: 9649, departament_id: 4},
        {name: 'Пластика рецессии десны местными тканями (в области 1 зуба)', price: 5108, departament_id: 4},
        {name: 'Применение Mucograft, Mucoderm', price: 17850, departament_id: 4},
        {name: 'Пародонтальная повязка', price: 580, departament_id: 4},
        {name: 'Медикаментозная обработка полости рта', price: 341, departament_id: 4},
        {name: 'Шинирование стекловолокном (1 зуб)', price: 1992, departament_id: 4},
        {name: 'Пластика десны свободным трансплататом', price: 9081, departament_id: 4},
        {name: 'Применение резорбируемой мембраны Bio-Gide 30*40мм', price: 26200, departament_id: 4},
        {name: 'Применение резорбируемой мембраны Bio-Gide 25*25мм', price: 17000, departament_id: 4},
        {name: 'Пин «Meizinger» (за 1 единицу)', price: 2100, departament_id: 4},
        {name: 'Изъятие костного блока (костная стружка)', price: 12500, departament_id: 4},
        {name: '«Консервация» лунки удаленного зуба', price: 10000, departament_id: 4},
        {name: 'Швы (нерассасывающиеся)', price: 1700, departament_id: 4},
        {name: 'Удаление ретинированного третьего моляра под общей анестезией', price: 12000, departament_id: 4},
    ]
)
