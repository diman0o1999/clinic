...
Departament.create(
    [
        {departament__name: 'Терапия'},
        {departament__name: 'Протезирование'},
        {departament__name: 'Хирургия'},
        {departament__name: 'Пародонтология'},
        {departament__name: 'Ортодонтия'},
        {departament__name: 'Детская стоматология'},
        {departament__name: 'Рентгенология'},
        {departament__name: 'Имплантация'},
        {departament__name: 'Анестезиологические услуги'},
        {departament__name: 'Эстетическая реставрация'},
        {departament__name: 'Профессиональная гигиена'}
    ]
)
